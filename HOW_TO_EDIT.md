...
- **Speakers** — 왼쪽 이름 목록 위에 마우스를 올리거나(터치는 탭) ↑↓ 키로 옮기면 오른쪽 큰 초상과 소속이 바뀝니다. 목록 맨 아래 **+ Add speaker**로 추가하고 각 이름 오른쪽의 빨간 **×**로 삭제합니다. 확정: Seung Yeul Ji, Ju Hyun Lee, Michael Ostwald, Hanjong Jun, Kyung Ho Ko, Yeon Shim Chung, Luo Mi, Yun Kyung Lee, Daeil Song.
