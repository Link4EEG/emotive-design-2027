...
- **Speakers** — 인물 카드를 클릭하거나 좌우 화살표 키·이동 버튼으로 프로필을 전환합니다. **+ Add speaker**로 추가하고 카드의 빨간 **×**로 삭제합니다. 확정: Seung Yeul Ji, Ju Hyun Lee, Michael Ostwald, Hanjong Jun, Kyung Ho Ko, Yeon Shim Chung, Luo Mi, Yun Kyung Lee.
